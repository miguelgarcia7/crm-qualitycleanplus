...
const statusBadge = (s: string) => (s === 'received' ? 'bg-success/15 text-success' : s === 'cancelled' ? 'bg-danger/15 text-danger' : 'bg-secondary/15 text-secondary')
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={onClose}>
      <div className="card w-full max-w-lg" onClick={(e) => e.stopPropagation()}>
        <div className="card-header"><h4 className="card-title">New Purchase Order</h4></div>
