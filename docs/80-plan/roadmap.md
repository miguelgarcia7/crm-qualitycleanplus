...
| 07 | Field check-in flows (recruiter + contractor QR) | 2-3 weeks | 🚧 07a contractor QR clock-in ✅ (`phase-07a-contractor-clock-in.md`); 07b recruiter visits + tablet/Sanctum path pending |
