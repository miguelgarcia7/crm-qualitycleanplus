...
| Last updated | 2026-06-09 (through Phase 08b-ii) |
...
| 08 | KB + Applicants + Job postings + PTO | 3-4 weeks | 🚧 08a PTO ✅ (`phase-08a-pto.md`); 08b-i marketing + public job board + applications ✅ (`phase-08b-i-marketing-applications.md`); 08b-ii back-office recruiting ✅ (`phase-08b-ii-backoffice-recruiting.md`); 08c KB pending |
